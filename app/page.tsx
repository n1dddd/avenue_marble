...
export default function Home() {
  return (
    <main className="grid grid-cols-12 auto-rows-auto gap-y-8">
      <div className="col-start-1 col-end-12 mt-8">
        <Image
          src={hero}
      ...
      <hr className="col-start-1 col-end-12 my-8" />
      <div className="col-start-1 col-end-7">
        <p className="text-left text-sm 2xl:text-3xl xl:text-3xl lg:text-2xl md:text-lg sm:text-sm font-light">
          ...
          restoration, marble cleaning, diamond grinding, diamond polishing and
          any other type of marble care.
        </p>
      </div>
      <div className="relative col-start-8 col-end-12">
        <Image
      ...
      <hr className="col-start-1 col-end-12" />
      ...
      <div className="col-start-8 col-end-12">
        <p className="text-left text-sm 2xl:text-3xl xl:text-3xl lg:text-2xl md:text-lg sm:text-md font-light">
          ...
          hard wear and even direct sunbeams. Cleaning marble floors requires a
          gentle and careful approach. Apart from gentle daily care, marble
          floors needs preventive stone floor restoration methods. Marble
          restoration includes marble polishing, diamond grinding, sealing and
          ground cleaning. Stone repair will also protect your marble floor or
          any other stone tiles from all the hazards.
        </p>
      </div>
      <hr className="col-start-1 col-end-12" />
      <div className="col-start-1 col-end-7">
        <p className="text-left text-sm 2xl:text-3xl xl:text-2xl lg:text-1xl md:text-lg sm:text-md font-light">
          ...
          used for both residential and commercial designs. The luxurious beauty
          of granite and marble is charming.
        </p>
      </div>
      <div className="relative col-start-8 col-end-12">
        <Image
